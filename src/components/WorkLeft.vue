<template>
    <div class="skill-container">
        ...
        <div class="skill-container__bottom">
            ...
            <div class="skill-img photoshop" @mouseenter="step = 6"><svg :class="{skill_focus: step == 6}" version="1.1"
                    id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                    y="0px" viewBox="0 0 17.469 17.469" style="enable-background:new 0 0 17.469 17.469;"
                    xml:space="preserve">
